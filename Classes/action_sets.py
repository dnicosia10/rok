...
class ActionSets:
    ...
    def farm_rss (self):
        ...
        machine.add_state("cornicon", FindAndClickImageAction('Media/cornicon.png', delay=2), "searchaction","restart")
        machine.add_state("goldicon", FindAndClickImageAction('Media/goldicon.png'), "searchaction","restart")
        machine.add_state("stoneicon", FindAndClickImageAction('Media/stoneicon.png', delay=2), "searchaction","restart")
        machine.add_state("searchaction", FindAndClickImageAction('Media/searchaction.png'), "gatheraction","logicon")
        machine.add_state("arrow", ManualClickAction(x=50, y=50, delay=3.5), "gatheraction","restart")
        machine.add_state("gatheraction", FindAndClickImageAction('Media/gatheraction.png', delay=2), "newtroopaction","restart")
